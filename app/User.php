...
class User extends Authenticatable
{
    ...
    {
        if($this->password == '') {
            return '<span class="badge badge-danger">Aucun mot de passe défini</span>';
        } else {
            if($this->m3pin == 1) {
                return '<span class="badge badge-light">PIN M3</span>';
            } else {
                return '<span class="badge badge-info-full">Mot de passe personnalisé</span>';
            }
        }
    }
